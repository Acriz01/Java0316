...
public class ExtendsDemo {
    public static void main(String[] args) {
        ...
        //-------------------
        System.out.println("請問總薪資salary是多少");
        ...
        for(Employee e:employees){
         ...
         System.out.printf("總薪資:%,d\n",sum3);
         //java 8 使用方法參考::
         int sum4=Stream.of(employees).mapToInt(Employee::getSalary)/*轉換成Employee內的getSalary*/.sum();
         System.out.printf("使用方法參考:: sum4總薪資:%,d\n",sum4);
         
         //Manager總薪資java7
         int sum5=0;
         for(Employee e:employees){
             if(e.getClass().getSimpleName().equals("Manager")){//.getName()只給全名(含package name)
                 sum5+=e.getSalary();
             }
